...
public class UserCityController {
    ...
    public ListResponse<UserCitySimple> list(UserCitySearchRequest request) {
        ...
        */
        ...
        <UserCityResponse> create(@Validated(AddOperator.class) UserCityDataRequest request) {
            return userCityApi.create(request);
        }

        @UpdateData
       @RequestMapping("/update")
       public ResponseObject<UserCityResponse> update(@Validated(UpdateOperator.class) UserCityDataRequest request) {
