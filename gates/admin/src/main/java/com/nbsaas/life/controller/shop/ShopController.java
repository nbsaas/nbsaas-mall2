...
public class ShopController {
    ...
    public ListResponse<ShopSimple> list(ShopSearchRequest request) {
        ...
        */
        ...
        <ShopResponse> create(@Validated(AddOperator.class) ShopDataRequest request) {
            return shopApi.create(request);
        }

        @UpdateData
       @RequestMapping("/update")
       public ResponseObject<ShopResponse> update(@Validated(UpdateOperator.class) ShopDataRequest request) {
