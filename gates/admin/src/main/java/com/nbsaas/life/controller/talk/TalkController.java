...
public class TalkController {
    ...
    public ListResponse<TalkSimple> list(TalkSearchRequest request) {
        ...
        */
        ...
        <TalkResponse> create(@Validated(AddOperator.class) TalkDataRequest request) {
            return talkApi.create(request);
        }

        @UpdateData
       @RequestMapping("/update")
       public ResponseObject<TalkResponse> update(@Validated(UpdateOperator.class) TalkDataRequest request) {
