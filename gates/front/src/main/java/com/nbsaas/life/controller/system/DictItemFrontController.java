...
public class DictItemFrontController {
    ...
    public PageResponse
            <DictItemSimple> search(DictItemSearchRequest request) {
        return dictItemApi.search(request);
    }

    @RequestMapping("/list")
    public ListResponse
            <DictItemSimple> list(DictItemSearchRequest request) {
    ...
    public ResponseObject
            <DictItemResponse> create(@Validated(AddOperator.class) DictItemDataRequest request) {
    ...
    public ResponseObject
            <DictItemResponse> update(@Validated(UpdateOperator.class) DictItemDataRequest
                                              request) {
        return dictItemApi.update(request);
    }

    @RequestMapping("/delete")
    public ResponseObject<?> delete(@Validated(DeleteOperator.class) DictItemDataRequest
                                            request) {
    ...
    @RequestMapping("/view")
    public ResponseObject
            <DictItemResponse> view(@Validated(ViewOperator.class) DictItemDataRequest
                                            request) {
