...
import com.nbsaas.life.user.api.domain.request.UserPasswordSearchRequest;
...
public class UserPasswordFrontController {
  ...
  @RequestMapping("/create")
   ...
   public ResponseObject
    <UserPasswordResponse> update(@Validated(UpdateOperator.class) UserPasswordDataRequest request) {
